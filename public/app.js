...
app.client.request = function(queryStringObjectheaders, path, method, queryStringObject, payload, callback) {
  // Set defaults
  ...
  for(var queryKey in queryStringObject) {
    if(queryStringObject.hasOwnProperty(queryKey)) {
      counter ++;
      // If at least one query string param has already been added, prepend new ones with &
      if(counter > 1) {
        requestUrl += '&';
      }
